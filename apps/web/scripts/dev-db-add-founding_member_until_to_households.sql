...
-- 4. Create new trigger on households (first 100, 12 months)
-- Note: COUNT(*) per insert is O(n); acceptable for "first 100" use. For high-throughput production, use a counter table.
