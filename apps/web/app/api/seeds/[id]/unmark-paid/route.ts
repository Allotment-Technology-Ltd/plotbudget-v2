...
import { unmarkSeedPaid } from '@/lib/actions/ritual-actions';
...
/**
 * POST /api/seeds/[id]/unmark-paid
 * Unmark a seed as paid. Used by native app (passes Bearer token).
...
export async function POST(
  ...
  const result = await unmarkSeedPaid(seedId, payer as Payer, supabase);
