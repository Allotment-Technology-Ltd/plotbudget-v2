...
import { getPaymentUiVisibleFromEnv, getFullPremiumVisibleFromEnv, getPWYLPricingEnabledFromEnv, getFixedPricingEnabledFromEnv, getAvatarEnabledFromEnv } from '@/lib/feature-flags';
...
export default async function PricingPage() {
  ...
  const fullPremiumVisible = getFullPremiumVisibleFromEnv();
