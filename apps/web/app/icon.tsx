 ...
 * Renders the "P" mark: dark background (#111111), mint fill (#69F0AE), light stroke (#E5E5E5).
...
const LOGO_SVG = `<svg width="512" height="512" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M429.333 56H82.6667C67.9391 56 56 67.9391 56 82.6667V429.333C56 444.061 67.9391 456 82.6667 456H429.333C444.061 456 456 444.061 456 429.333V82.6667C456 67.9391 444.061 56 429.333 56Z" stroke="#E5E5E5" stroke-width="16"/>
