...
- **Cursor ↔ Linear:** Install the Linear extension in Cursor (VS Code–compatible). Use command palette: "Linear: Create Issue" for dev-first flow; use "Copy Branch Name" in Linear for plan-first flow.
